    ...
    <section id="experience" className="section-padding bg-gradient-to-b from-gray-light to-white dark:from-gray-800 dark:to-gray-900 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="group relative bg-gradient-to-br from-white to-gray-light dark:from-gray-700 dark:to-gray-800 rounded-2xl p-8 md:p-10 shadow-xl hover:shadow-2xl transition-all duration-300 border-l-4 border-primary-dark transform hover:-translate-y-2 overflow-hidden">
            {/* Decorative corner element */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 dark:bg-primary/10 rounded-bl-full"></div>
